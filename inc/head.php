...
{	
	...
	{		
		...
		mysql_query("INSERT INTO msg(text,usr_id,new,dt)
						VALUES(
							'A new account has been registered: ".$_POST['username']."',
							'".$user."',
							1,
							now()
						)");
