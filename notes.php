...
//SQL
	...
	$ntqry = 'SELECT notes.id, notes.dt, notes.note, notes.org_id, members.usr FROM notes INNER JOIN members ON notes.usr_id=members.id WHERE org_id = '.$orgid.' ORDER BY notes.dt DESC';
